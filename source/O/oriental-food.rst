...
Hackers display an intense tropism towards oriental cuisine, especially Chinese, and especially of the spicier varieties such as Szechuan and Hunan.
...
See also :ref:`ravs`\, :ref:`great-wall`\, :ref:`stir-fried-random`\, :ref:`laser-chicken`\, :ref:`Yu-Shiang-Whole-Fish`\.
Thai, Indian, Korean, Burmese, and Vietnamese cuisines are also quite popular.
