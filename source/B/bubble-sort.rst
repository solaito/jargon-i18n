...
Because it is not very good relative to other methods and is the one typically stumbled on by :ref:`naive` and untutored programmers, hackers consider it the :ref:`canonical` example of a naive algorithm.
(However, it's been shown by repeated experiment that below about 5000 records bubble-sort is OK anyway.)
The canonical example of a really *bad* algorithm is :ref:`bogo-sort`\.
